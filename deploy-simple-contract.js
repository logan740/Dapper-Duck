...
async function main() {
  console.log("Deploying DapperDuckSimple contract...");
  ...
  const contractArtifact = require("./artifacts/contracts/DapperDuckSimple.sol/DapperDuckSimple.json");
  ...
  console.log("DapperDuckSimple deployed to:", contract.address);
  ...
  console.log("Contract Balance:", ethers.utils.formatEther(stats[2]), "ETH");
